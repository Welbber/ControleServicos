...
import br.com.vital.controle_servico.auth.exception.CustomJwtException;
...
public class ResponseExceptionHandler extends DefaultHandlerExceptionResolver {
    ...
    public ResponseEntity<Object> handleArgumentStateForbidden(final RuntimeException ex) {
        final var apiError = new ApiError(HttpStatus.FORBIDDEN, "Acesso negado");
        return handleArgumentState(apiError);
    }
